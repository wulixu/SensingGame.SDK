...
Public Class Form1
    ...
    Private Sub StartUpdateButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles StartUpdateButton.Click
        ' timer starts
        timer.Start()
    End Sub

    Private Sub StopUpdateButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles StopUpdateButton.Click
        ' timer stops
        timer.[Stop]()
    End Sub
