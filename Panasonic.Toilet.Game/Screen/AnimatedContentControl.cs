//-----------------------------------------------------------------------
// <copyright file="AnimatedContentControl.cs" company="Cobon Tech">
...
namespace TronCell.Game.Screen
{
	...
	public class AnimatedContentControl : ContentControl
	{
		...
		{
			if (m_paintArea != null && m_mainContent != null && m_mainContent.Content !=null)
			{
		...
		private void BeginAnimateContentReplacement()
		{
            ...
            //newContentTransform.BeginAnimation(UIElement.OpacityProperty, CreateAnimation(0, 1));
			//newContentTransform.BeginAnimation(TranslateTransform.XProperty, CreateAnimation(this.ActualWidth/2, 0));
			//oldContentTransform.BeginAnimation(TranslateTransform.XProperty, CreateAnimation(0, -this.ActualWidth/2, (s,e) => m_paintArea.Visibility = Visibility.Hidden));
		}
		...
		{
			if (v == null) throw new ArgumentNullException("Visual is null.");
            //Todo:refactory. will need deal with dpi.
